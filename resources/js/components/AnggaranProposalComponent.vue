        ...
        <table class="table table-borderless table-striped table-hover">
                ...
                <tbody>
                    <tr v-for="(anggaran, index) in anggarans">
                        ...
                        <input type="hidden" class="form-control" :name="`anggarans[${index}][anggaranDeskripsi]`" v-model="anggaran.anggaranDeskripsi"> 
                        ...
                        <input type="hidden" class="form-control" :name="`anggarans[${index}][id]`" v-model="anggaran.anggaranID"> 
        ...
        <div class="modal fade" id="anggaranModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Form Anggaran</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="anggaranDeskripsi" class="col-form-label">Anggaran Deskripsi:</label>
                        <input type="text" class="form-control" id="anggaranDeskripsi" name="anggaranDeskripsi" placeholder="Masukkan Anggaran Deskripsi" v-model="anggaran.anggaranDeskripsi">
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="submitAnggaran" class="btn btn-primary" @click="addAnggaran">Submit</button>
                </div>
                </div>
            </div>
            </div>
        ...
        methods: {
            addAnggaran(){
                ...
                if (this.anggaran && this.anggaran.anggaranID) {
                    let idx = this.anggarans.findIndex((obj => obj.anggaranID == this.anggaran.anggaranID));
