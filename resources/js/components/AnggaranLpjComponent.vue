            ...
            <tbody>
                <tr v-for="(anggaran, index) in anggarans">
                    ...
                    <input
                        type="hidden"
                        class="form-control"
                        :name="`anggarans[${index}][pengeluaranDeskripsi]`"
                        v-model="anggaran.pengeluaranDeskripsi"
                    />
                    <input
                        type="hidden"
                        class="form-control"
                    ...
                    <input
                        ...
                        v-model="anggaran.pengeluaranID"
                    />
                    <input
                        type="hidden"
                        class="form-control"
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group">
                                <label
                                    for="pengeluaranDeskripsi"
                                    class="col-form-label"
                                    >Pengeluaran Deskripsi:</label
                                >
                                <input
                                    type="text"
                                    class="form-control"
                                    id="pengeluaranDeskripsi"
                                    name="pengeluaranDeskripsi"
                                    placeholder="Masukkan Pengeluaran Deskripsi"
                                    v-model="anggaran.pengeluaranDeskripsi"
                                />
                            </div>
...
export default {
    ...
    methods: {
        ...
        addAnggaran() {
            ...
            let valAnggaranDeskripsi = document.getElementById(
                "pengeluaranDeskripsi"
            ).value;
                ...
                if (
                    ...
                    if (this.anggaran && this.anggaran.pengeluaranID) {
                        let idx = this.anggarans.findIndex(
                            (obj) =>
                                obj.pengeluaranID == this.anggaran.pengeluaranID
                        );
