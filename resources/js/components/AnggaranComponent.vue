        ...
        <table class="table table-borderless table-striped table-hover">
                ...
                <tbody>
                    <tr v-for="(anggaran, index) in anggarans">
                        ...
                        <input type="hidden" class="form-control" :name="`anggarans[${index}][id]`" v-model="anggaran.anggaranPropelID"> 
        ...
        <div class="modal fade" id="anggaranModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-footer">
                    ...
                    <button id="submitAnggaran" type="button" class="btn btn-primary" @click="addAnggaran">Submit</button>
                </div>
                </div>
            </div>
            </div>
