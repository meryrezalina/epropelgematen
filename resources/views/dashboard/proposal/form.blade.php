                ...
                <div class="col-md-8 offset-md-2">
                    <form method="post" action="{{ route($url, $proposals->proposalID ?? '') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('sasaranStrategis') {{ 'is-invalid' }} @enderror"
                        ...
                        <div class="card mb-2">
                            <div class="card-body">
                                <div class="form-group mb-0">
                                 ...
                                 <anggaran-proposal-component :sumber-dana="{{ $sum ?? json_encode(old('sum') ?? []) }}" :list-of-anggaran="{{ json_encode($anggarans) ?? json_encode(old('anggarans') ?? []) }}"></anggaran-proposal-component>
                            </div>
                            @error('columns')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="total-biaya form-control @error('totalBiaya') {{ 'is-invalid' }} @enderror"
                                name="totalBiaya" id="totalBiaya"
                                value="{{ old('totalBiaya') ?? $proposals->totalBiaya ?? '' }}" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);">
                            @error('totalBiaya')
                        ...
                        <div class="card mb-2">
                            <div class="card-body">
                                ...
                                <indikator-proposal-component :list-of-indikator="{{json_encode($indikators) ?? json_encode(old('indikators') ?? []) }}"></indikator-proposal-component>
                            </div>
                            @error('columns')
                        ...
                        <div class="card mb-2">
                            <div class="card-body">
                                ...
                                <rincian-proposal-component :list-of-rincian="{{json_encode($rincians) ?? json_encode(old('rincians') ?? []) }}"></rincian-proposal-component>
                            </div>
                            @error('columns')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kabidApprover') {{ 'is-invalid' }} @enderror"
                        ...
                        <div class="mb-2">
                            <div class="form-check form-check-inline">
                                <input type="checkbox" name="approvedbyRomo" class="form-check-input" value="Disetujui" id="approvedbyRomo" @if((old('approvedbyRomo') ?? $proposals->approvedbyRomo ?? '') == 'Disetujui') checked @endif>
                                <label for="approvedbyRomo" class="form-check-label">Disetujui Romo</label>
                            </div>

                            <div class="form-check form-check-inline">
                                <input type="checkbox" name="approvedbyKabid" class="form-check-input" value="Disetujui" id="approvedbyKabid" @if((old('approvedbyKabid') ?? $proposals->approvedbyKabid ?? '') == 'Disetujui') checked @endif>
                        ...
                        <div class="mb-2">
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="status" class="form-check-input" value="Disetujui" id="Disetujui"
                                    @if ((old('status') ?? ($proposals->status ?? '')) == 'Disetujui') checked @endif>
