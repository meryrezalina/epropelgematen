                            ...
                            <table class="table table-borderless table-striped table-hover">
                                ...
                                <tbody id="dataIndikator">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-outline-success btn-sm edit-indikator"
                                            ...
                                            <button type="button" class="btn btn-outline-danger btn-sm hapus-indikator"
                                        ...
                                        <input type="hidden" class="form-control"
                                            name="indikators[{{ $loop->index }}][target]" value="{{ $indkts->target }}">
                                        <input type="hidden" class="form-control"
                    ...
                    <div class="mb-2">
                        ...
                        <div class="form-check form-check-inline">
                            <input type="checkbox" name="approvedbyRomo" class="form-check-input" value="Disetujui"
                                id="approvedbyRomo" @if ((old('approvedbyRomo') ?? ($lpj->approvedbyRomo ?? '')) ==
                            'Disetujui') checked @endif>
                        ...
                        <div class="form-check form-check-inline">
                            <input type="checkbox" name="approvedbyKabid" class="form-check-input" value="Disetujui"
                                id="approvedbyKabid" @if ((old('approvedbyKabid') ?? ($lpj->approvedbyKabid ?? '')) ==
                            'Disetujui') checked @endif>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="target" placeholder="Masukkan Target" required>
                    </div>

                    <div class="form-group">
                        <label for="pencapaianLPJ" class="col-form-label">Pencapaian LPJ:</label>
                        <input type="text" class="form-control" id="pencapaianLPJ" placeholder="Masukkan Pencapaian LPJ"
                            required>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#proposal-select").change(function() {
                proposal.forEach(prop => {
                    if ($("#proposal-select").val() == prop.proposalID) {
                        ...
                        let filterIndikator = indikatorJS.filter(obj => obj.proposalID == prop.proposalID);
            ...
            $('.tambah-indikator').click(function(){
                $('#indikatorDeskripsi').val('');
                $('#target').val('');
                $('#pencapaianLPJ').val('');

                eventIndikator = $('.tambah-indikator').val();
            });
            ...
            $("#submitIndikator").click(function() {
                if($('#indikatorDeskripsi').val() == '' || $('#target').val() == '' || $('#pencapaianLPJ').val() == ''){
                    ...
                    if (lpj != 'kosong') {
                        ...
                        if(eventIndikator == 'tambahIndikator'){
                            newIndikator.indikatorLpjID = (indikatorJS[indikatorJS.length-1]['indikatorLpjID'] + 1);
                            indikatorJS.push(newIndikator);
                        }else{
