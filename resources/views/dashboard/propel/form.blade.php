                ...
                <div class="col-md-8 offset-md-2">
                    <form method="post" action="{{ route($url, $propel->propelID ?? '') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('namaKegiatan') {{'is-invalid'}} @enderror" name="namaKegiatan" placeholder="Masukkan Nama Kegiatan" value="{{ old('namaKegiatan') ?? $propel->namaKegiatan ?? ''}}">
                            @error('namaKegiatan')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nomorRAPB') {{'is-invalid'}} @enderror" name="nomorRAPB" placeholder="Massukan Nomor RAPB" value="{{ old('nomorRAPB') ?? $propel->nomorRAPB ?? ''}}">
                            @error('nomorRAPB')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('namaPJ') {{'is-invalid'}} @enderror" name="namaPJ" placeholder="Masukkan Nama Penanggung Jawab" value="{{ old('namaPJ') ?? $propel->namaPJ ?? ''}}">
                            @error('namaPJ')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('sasaranStrategis') {{'is-invalid'}} @enderror" name="sasaranStrategis" placeholder="Masukkan Sasaran Strategis" value="{{ old('sasaranStrategis') ?? $propel->sasaranStrategis ?? ''}}">
                        ...
                        <div class="card mb-2">
                            <div class="card-body">
                                <div class="form-group mb-0">
                                 ...
                                 <anggaran-coba-component :sumber-dana="{{ $sum ?? json_encode(old('sum') ?? []) }}" :list-of-anggaran="{{ json_encode($anggarans) ?? json_encode(old('anggarans') ?? []) }}"></anggaran-coba-component>
                            </div>
                            @error('anggarans')
                        ...
                        <div class="card mb-2">
                            <div class="card-body">
                                ...
                                <indikator-component :list-of-indikator="{{json_encode($indikators) ?? json_encode(old('indikators') ?? []) }}"></indikator-component>
                            </div>
                            @error('indikators')
                        ...
                        <div class="card mb-2">
                            <div class="card-body">
                                ...
                                <rincian-component :list-of-rincian="{{json_encode($rincians) ?? json_encode(old('rincians') ?? []) }}"></rincian-component>
                            </div>
                            @error('rincians')
                        ...
                        <div class="mb-2">
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" name="status" class="form-check-input" value="Review Ulang" id="Review Ulang"
                                    @if ((old('status') ?? ($propel->status ?? '')) == 'Review Ulang') checked @endif>
                                <label for="Review Ulang" class="form-check-label">Review Ulang</label>
                            </div>

                            <div class="form-check form-check-inline">
                                <input type="radio" name="status" class="form-check-input" value="Disetujui" id="Disetujui"
                                    @if ((old('status') ?? ($propel->status ?? '')) == 'Disetujui') checked @endif>
