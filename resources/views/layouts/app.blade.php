...
<body >
    <div id="app">
        <nav class="navbar navbar-expand-md" style="opacity: 1.0; color: white;">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}" style="color:floralwhite; font-weight: bold">
                ...
                <div class="collapse navbar-collapse show" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                {{-- <a class="nav-link" href="{{ route('login') }}" style="color:floralwhite; font-weight: 600; text-transform: uppercase; font-size: 20px; letter-spacing: 0.1rem">{{ __('Login') }}</a> --}}
                            </li>
                            {{-- @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}" style="color:floralwhite; font-weight: 600; text-transform: uppercase; font-size: 20px; letter-spacing: 0.1rem">{{ __('Register') }}</a>
                                </li>
                            @endif --}}
                        @else
